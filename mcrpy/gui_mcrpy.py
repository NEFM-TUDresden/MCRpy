...
def call_main():
    ...
    group_cha_req.add_argument('--microstructure_filenames', nargs='+', type=str, help='File of microstructure to reconstruct', widget='FileChooser', gooey_options=GOOEY_OPTIONS)
    ...
    group_cha_des.add_argument('--periodic', type=str2bool, dest='periodic', choices=[True, False], gooey_options=GOOEY_OPTIONS)
    ...
    group_rec_des.add_argument('--periodic', type=str2bool, dest='periodic', choices=[True, False], gooey_options=GOOEY_OPTIONS)
    ...
    group_mat_req.add_argument('--microstructure_filenames', nargs='+', type=str, help='File of microstructure to reconstruct', widget='FileChooser', gooey_options=GOOEY_OPTIONS)
    ...
    group_mat_des.add_argument('--periodic', type=str2bool, dest='periodic', choices=[True, False], gooey_options=GOOEY_OPTIONS)
